...
> Generated 2026-08-10 at v0.6.1 (commit `57366e9`). Line numbers are accurate
> as of that commit and may drift — treat them as starting points and verify
...
- [album-detail-page.md](album-detail-page.md) — `/albums/:slug`: view, admin strip, long-press menu
